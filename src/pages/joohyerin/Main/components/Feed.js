  ...
  return (
    <div>
      {feedInfoList.map((feedInfo) => {
        return (
          <article className="feed" key={feedInfo.id}>
            <div className="feed-head">
              <div className="feed-profile">
                <img
                  className="img-profile-32px"
                  src={`${process.env.PUBLIC_URL}/images/joohyerin/${feedInfo.profileImage}`}
                  alt="프로필 이미지"
                />
                <div>
                  <p className="feed-userId">{feedInfo.userId}</p>
                  <p className="feed-location">{feedInfo.location}</p>
                </div>
              </div>
              <img
                className="icon-more"
            ...
            <img
              className="feed-img"
              src={`${process.env.PUBLIC_URL}/images/joohyerin/${feedInfo.feedImage}`}
              alt="피드 이미지"
            />
